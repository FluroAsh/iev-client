...
const {getChargers} = require("./chargerServices")
...
describe("addCharger function", () => {
  ...
  it("return all chargers details", async () => {
    // mock the fetch results to be successful

    axios.get.mockResolvedValue(allChargers)
    ...
    expect(result[0]["name"]).toBe("Super Charger Test 1");
